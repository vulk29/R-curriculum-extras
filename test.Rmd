...
If you find yourself with a problem, for example, I want to include a nice twitter embed into this website to make it look cool (and prove my point). I googled "embed tweet markdown", clicked the first link and here it is.
